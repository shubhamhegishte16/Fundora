 ...
 */
export default function AppShell({ activePage, onNavigate, title, subtitle, creatorName, creatorRole, creatorAvatarUrl, children }) {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <main className="min-w-0 flex-1">
        <TopBar title={title} subtitle={subtitle} onMenuClick={() => setSidebarOpen(true)} creatorName={creatorName} creatorRole={creatorRole} creatorAvatarUrl={creatorAvatarUrl} />
