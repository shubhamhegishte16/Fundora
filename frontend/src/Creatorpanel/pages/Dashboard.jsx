...
import { statCards, fundingPoints, fundingLabels, donationSegments, donationDisplayTotal, allCampaigns, recentDonations } from '../data.js';
...
export default function Dashboard({ onNavigate }) {
  const previewCampaigns = allCampaigns.slice(0, 3);
  const previewDonations = recentDonations.slice(0, 4);
