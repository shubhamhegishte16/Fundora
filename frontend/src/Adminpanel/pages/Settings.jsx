...
const Toggle = ({ enabled, onChange }) => (
  <button onClick={() => onChange(!enabled)}
    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${enabled ? "bg-[#2D6A4F]" : "bg-gray-200"}`}>
            ...
            <div className="border border-gray-100 rounded-2xl p-4 space-y-3">
              ...
              {[
                ...
                <div key={i} className="flex items-center justify-between py-2.5 border-t border-gray-50">
                  ...
                  {i !== 0 && <button className="text-xs text-red-500 hover:underline font-medium">Revoke</button>}
                  {i === 0 && <span className="text-xs bg-green-100 text-green-700 px-2.5 py-0.5 rounded-full font-medium">Active</span>}
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              {[
                ...
                <div key={n.key} className="flex items-center justify-between p-4 bg-[#F0F7F4] rounded-2xl">
                  <div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={s.key} className={`flex items-center justify-between p-4 rounded-2xl border ${s.danger ? "bg-red-50 border-red-100" : "bg-[#F0F7F4] border-transparent"}`}>
                  <div>
          ...
          {tabs.map((t) => (
            <button key={t.id} onClick={() => setActiveTab(t.id)}
              className={`w-full flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all
                ${activeTab === t.id ? "bg-[#2D6A4F] text-white shadow-sm" : "text-gray-600 hover:bg-[#F0F7F4]"}`}>
