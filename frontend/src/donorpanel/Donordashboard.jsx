...
const DonorPanel = () => {
  ...
  const [user] = useState(() => {
    ...
    } catch (e) { return { name: "Arjun Sharma" }; }
  });
  ...
  const recentDonations = [
    ...
    { id: 5, title: "Animal Shelter Care", creator: "Paws & Hearts", status: "Completed", date: "21 May 2026", image: "https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=120&auto=format&fit=crop" }
  ];

  // Recommended campaigns mock data matching Figma
  const recommendedCampaigns = [
    { id: 1, title: "Empower Rural Education", creator: "Teach India", progress: 65, raised: "₹16,25,000", goal: "₹25,00,000", image: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=400&auto=format&fit=crop" },
    { id: 2, title: "Support Cancer Patients", creator: "Hope Foundation", progress: 45, raised: "₹4,50,000", goal: "₹10,00,000", image: "https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?w=400&auto=format&fit=crop" },
    { id: 3, title: "Save Our Rivers", creator: "River Warriors", progress: 80, raised: "₹16,00,000", goal: "₹20,00,000", image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=400&auto=format&fit=crop" }
  ];
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-20 bg-white border-b border-brand-border/60 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between shadow-xs">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            {/* Notification Bell */}
            <button className="relative text-brand-text p-2.5 hover:bg-slate-50 rounded-full transition-all cursor-pointer border border-brand-border/60"><Bell size={20} /><span className="absolute top-2 right-2 w-2.5 h-2.5 bg-brand-error rounded-full ring-2 ring-white" /></button>
            ...
            <>
              ...
              <section className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
                ...
                <div className="bg-card-white border border-brand-border/60 rounded-2xl p-3.5 sm:p-5 flex items-center gap-3 sm:gap-4.5 shadow-sm">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-emerald-50 text-[#10B981] flex items-center justify-center shrink-0"><TrendingUp size={24} /></div>
                ...
                {/* Stat Card 2 */}
                <div className="bg-card-white border border-brand-border/60 rounded-2xl p-3.5 sm:p-5 flex items-center gap-3 sm:gap-4.5 shadow-sm">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-emerald-50 text-[#10B981] flex items-center justify-center shrink-0"><Users size={24} /></div>
                  <div className="leading-tight">
                ...
                {/* Stat Card 3 */}
                <div className="bg-card-white border border-brand-border/60 rounded-2xl p-3.5 sm:p-5 flex items-center gap-3 sm:gap-4.5 shadow-sm">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-emerald-50 text-[#10B981] flex items-center justify-center shrink-0"><Award size={24} /></div>
                  <div className="leading-tight">
                ...
                {/* Stat Card 4 */}
                <div className="bg-card-white border border-brand-border/60 rounded-2xl p-3.5 sm:p-5 flex items-center gap-3 sm:gap-4.5 shadow-sm">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-emerald-50 text-[#10B981] flex items-center justify-center shrink-0"><Leaf size={24} /></div>
                  <div className="leading-tight">
                ...
                <div className="bg-card-white border border-brand-border/60 rounded-2xl p-4 sm:p-6 shadow-sm lg:col-span-3 flex flex-col">
                  ...
                  <div className="space-y-4 flex-1">
                    {recentDonations.map((donation) => (
                      <div key={donation.id} className="flex items-center justify-between p-2.5 sm:p-3 border border-brand-border/40 hover:border-brand-border rounded-xl transition-all hover:bg-slate-50/50">
                        <div className="flex items-center gap-3.5 min-w-0">
                          <img src={donation.image} alt={donation.title} className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg object-cover border border-brand-border/30 shadow-xs" />
                        ...
                        <div className="flex items-center gap-5 text-right shrink-0">
                          <div className="hidden sm:block leading-none">
                            <span className="inline-block px-2.5 py-1 text-[10px] font-bold text-[#059669] bg-[#E1FDEC] border border-[#A7F3D0]/60 rounded-md">{donation.status}</span>
                            <p className="text-[10px] text-brand-secondary font-medium mt-1.5">{donation.date}</p>
                          </div>
                          <span className="sm:hidden inline-block px-2 py-0.5 text-[9px] font-bold text-[#059669] bg-[#E1FDEC] rounded-md">{donation.status}</span>
                        </div>
                      </div>
                    ))}
                  </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 py-2">
                      <div className="relative w-28 h-28 sm:w-36 sm:h-36 flex items-center justify-center shrink-0">
                        <svg viewBox="0 0 100 100" className="w-full h-full transform -rotate-90">
                          <circle cx="50" cy="50" r="38" fill="transparent" stroke="#10B981" strokeWidth="12" strokeDasharray="95.5 238.7" strokeDashoffset="0" />
                          <circle cx="50" cy="50" r="38" fill="transparent" stroke="#A7F3D0" strokeWidth="12" strokeDasharray="76.4 238.7" strokeDashoffset="-95.5" />
                          <circle cx="50" cy="50" r="38" fill="transparent" stroke="#3B82F6" strokeWidth="12" strokeDasharray="47.7 238.7" strokeDashoffset="-171.9" />
                          <circle cx="50" cy="50" r="38" fill="transparent" stroke="#F59E0B" strokeWidth="12" strokeDasharray="23.9 238.7" strokeDashoffset="-219.6" />
                        </svg>
                      ...
                      <div className="flex-1 space-y-2.5 w-full">
                        <div className="flex items-center justify-between text-xs font-semibold">
                          <div className="flex items-center gap-2"><span className="w-3 h-3 rounded-full bg-[#10B981]" /><span className="text-brand-secondary">Education</span></div>
                          <span className="text-brand-text font-bold">₹1,000</span>
                        </div>
                        <div className="flex items-center justify-between text-xs font-semibold">
                          <div className="flex items-center gap-2"><span className="w-3 h-3 rounded-full bg-[#A7F3D0]" /><span className="text-brand-secondary">Environment</span></div>
                          <span className="text-brand-text font-bold">₹800</span>
                        </div>
                        <div className="flex items-center justify-between text-xs font-semibold">
                          <div className="flex items-center gap-2"><span className="w-3 h-3 rounded-full bg-[#3B82F6]" /><span className="text-brand-secondary">Health</span></div>
                          <span className="text-brand-text font-bold">₹500</span>
                        </div>
                        <div className="flex items-center justify-between text-xs font-semibold">
                          <div className="flex items-center gap-2"><span className="w-3 h-3 rounded-full bg-[#F59E0B]" /><span className="text-brand-secondary">Others</span></div>
                  ...
                  <div className="bg-card-white border border-brand-border/60 rounded-2xl p-4 sm:p-6 shadow-sm flex flex-col">
                    ...
                    <div className="space-y-4">
                      {recommendedCampaigns.map((camp) => (
                        <div key={camp.id} className="flex items-center gap-3 sm:gap-4 p-2.5 sm:p-3 border border-brand-border/30 hover:border-brand-border rounded-xl transition-all">
                          ...
                          <div className="flex-1 min-w-0 leading-tight">
                            ...
                            <div className="mt-2 space-y-1">
                              <div className="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden">
                                <div className="bg-[#10B981] h-1.5 rounded-full transition-all" style={{ width: `${camp.progress}%` }} />
                              </div>
